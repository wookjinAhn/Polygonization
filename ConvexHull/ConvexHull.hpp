...
public:
    ConvexHull();
    ConvexHull(std::vector<camelVector::Point3D>& inputPoint);
...
private:
    camelVector::Point3D nextToTop(std::stack<camelVector::Point3D>& pointStack);
    void swap(camelVector::Point3D& point1, camelVector::Point3D& point2);
    int distSq(camelVector::Point3D point1, camelVector::Point3D point2);
    int orientation(camelVector::Point3D p, camelVector::Point3D q, camelVector::Point3D r);
    int compare(const void* vp1, const void* vp2);
    void convexHull(std::vector<camelVector::Point3D> points);
